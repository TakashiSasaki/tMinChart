...
public class UsersTable {
    ...
    public final static String[] ALL_COLUMN_NAMES_UsersTable
            = new String[]{"name", "age", "sex", "affiliation", "correction", "fatigue", "longitude", "latitude", "address", "lastUsed"};

    public final static String CREATE_UsersTable =
            "CREATE TABLE UsersTable (_id INTEGER PRIMARY KEY autoincrement, " +
                    " name TEXT NOT NULL, age INTEGER, sex TEXT, affiliation TEXT, " +
                    " correction TEXT, fatigue TEXT, longitude REAL, latitude REAL, address TEXT, lastUsed INTEGER)";
    ...
    public void writeUsersTable(SQLiteDatabase database) {
        ...
        database.insert("UsersTable", null, content_values);
    }//writeUsersTable
}
